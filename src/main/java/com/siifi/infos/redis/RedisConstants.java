...
public class RedisConstants {
    ...
    public static final Integer datebase10=10;

    public static final Integer datebase11=11;

    public static final Integer datebase12=12;

    public static final Integer datebase13=13;
