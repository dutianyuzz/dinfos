...
public class SiteController {
    ...
    public String bottomNavigationBar() {
        return "siifi/bottom-navigation-bar";
    }
    ...
    public ModelAndView findColumn(Integer id) {
        ...
        ModelAndView model = new ModelAndView("siifi/about");
    ...
    public ModelAndView findIntell(Integer id) {
        ...
        ModelAndView model = new ModelAndView("siifi/industry-intelligent");
    ...
    public ModelAndView applyOnline(Integer id) {
        ...
        ModelAndView model = new ModelAndView("siifi/apply-online");
